...
export const ProtocolSchemas: Record<string, TSchema> = {
  ...
  AgentsSharedFilesListParams: AgentsSharedFilesListParamsSchema,
  AgentsSharedFilesListResult: AgentsSharedFilesListResultSchema,
  AgentsSharedFilesGetParams: AgentsSharedFilesGetParamsSchema,
  AgentsSharedFilesGetResult: AgentsSharedFilesGetResultSchema,
  AgentsSharedFilesSetParams: AgentsSharedFilesSetParamsSchema,
  AgentsSharedFilesSetResult: AgentsSharedFilesSetResultSchema,
